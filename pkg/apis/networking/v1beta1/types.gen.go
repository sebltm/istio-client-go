...
// +cue-gen:OCSPStaple:version:v1beta1
...
// -->
// <!-- istio code generation tags
// +istio.io/sync-from:networking/v1alpha3/ocsp_staple.proto
// -->
type OCSPStaple struct {
	...
	// Spec defines the implementation of this definition.
	// +optional
	Spec networkingv1beta1.OCSPStaple `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
